...
Accomodation.create(name: "Place sous-sol 1", nb_persons: "1", participant_id: nil, comment: "NB : Apporter son matelas à gonfler !")
Accomodation.create(name: "Place sous-sol 2", nb_persons: "1", participant_id: nil,  comment: "NB : Apporter son matelas à gonfler !")
